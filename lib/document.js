...
function Document(model, options) {
  ...
  this._options.context = (options.context != null) ? options.context : {};
  ...
  util.loopKeys(model._methods, extendDoc);
  util.loopKeys(options.context, extendDoc);

  function extendDoc(methods, key) {
